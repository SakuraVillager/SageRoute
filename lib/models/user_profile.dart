...
class UserProfile {
  ...
  factory UserProfile.fromJson(Map<String, dynamic> json) {
    ...
    return UserProfile(
      ...
      achievementsCount:
          (json['achievements_count'] ?? json['achievementsCount'] ?? 0) as int,
      exploredLocations:
          (json['explored_locations'] ?? json['exploredLocations'] ?? 0) as int,
      completedRoutes:
          (json['completed_routes'] ?? json['completedRoutes'] ?? 0) as int,
  ...
  UserProfile copyWith({
    ...
    exploredLocations: exploredLocations ?? this.exploredLocations,
